...
const filters = ["_1977", "aden", "amaro", "brannan", "brooklyn", "clarendon",
    "gingham", "inkwell", "lark", "maven", "moon", "nashville", "perpetua", "reyes", 
    "slumber", "stinson", "valencia","walden"];
...
(async () => {
  ...
  const outputDir = path.resolve("C:/Users/parsa/OneDrive/Desktop/CSCI 3240U/Project_Repos/Dataset/testing_data");
  if (!fs.existsSync(outputDir)) {
    fs.mkdirSync(outputDir, { recursive: true });
  }

  // Get all image files in the original_images directory
  const originalImagesDir = path.resolve("C:/Users/parsa/OneDrive/Desktop/CSCI 3240U/Project_Repos/Dataset/coco/testing_subset");
